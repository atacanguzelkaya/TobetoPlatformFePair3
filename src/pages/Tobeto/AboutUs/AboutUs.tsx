...
const AboutUs = () => {
  return (
    <>
      <OutBanner />
      <OutNavbar />
      <section className="py-5 mt-10 bg-front-dark">
        <div className="position-relative">
          <div className="container">
            <div className="row">
              <div className="col-md-7 col-12 my-10 flex-row ">
                <div className="flex-col">
                  <div className="tbt-logo">
                    <img
                      alt=""
                ...
                <div className="flex-col">
                  <p className="aboutus-text">
                    ...
                    <br />
                    <span>"headfarming"</span> olarak değiştirmeyi
                    <br />
                    hedefleyen, eğitim ve gelişim odaklı
                    <br />
          ...
          <Container>
            ...
            <Row className="mt-5">
              <div className="bg-gradient-gray">
                <span className="mb-10">Ekibimiz</span>
                <div className="craws">
                  <div className="craw">
                  ...
                  <div className="craw">
                    <div className="craw-image">
                      <Link to="https://www.linkedin.com/in/pelinbatir/">
                        <img
                          alt=""
                ...
                <span className="my-10">Danışma Kurulu</span>
                <div className="craws">
                  <div className="craw">
                    <div className="craw-image">
                      <Link
                  ...
                  <div className="craw">
                    <div className="craw-image">
                      <Link
                        target="_blank"
                        to="https://www.linkedin.com/in/atacik/"
                      >
                        <img
                          alt=""
                  ...
                  <div className="craw">
                    <div className="craw-image">
                      <Link
                        target="_blank"
                        to="https://www.linkedin.com/in/alpaslan-gursoy-97463a90/"
                      >
                        <img
                          alt=""
            ...
            <div className="container-fluid">
              <div className="row about-banner">
                <span className="mb-10">Ofisimiz</span>
            ...
            <div className="container-fluid">
              <div className="row followus-banner">
                <span className="mb-10">Bizi Takip Edin</span>
                <div className="col-12 col-lg-auto text-center">
                  ...
                  <Link
                    className="text-decoration-none me-4"
                    to="https://twitter.com/tobeto_platform"
                    target="blank"
                  >
                    <svg
                      width={24}
